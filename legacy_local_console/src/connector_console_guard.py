"""Claudia Console Mode guards for external connector writes (Package 11).
...
CORE_ROUTING_GUIDANCE = (
    "Route connector write requests through Claudia Core approval and governance. "
...
def connector_write_disabled(
    ...
    *,
    ...
    return {
        ...
        "message": message
        or (
            "Claudia Console Mode is active. Direct connector writes are disabled. "
            "Route this request through Claudia Core approval/governance."
        ),
