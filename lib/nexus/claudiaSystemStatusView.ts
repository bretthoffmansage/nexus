...
> = {
  core_api: {
    title: "Claudia Core API",
    description: "Core Claudia service and governed tool runtime.",
    liveStatus: "Running",
    inactiveStatus: "Stopped",
  },
  nexus_connector: {
    title: "Nexus Connector",
    description: "Trusted queue bridge between Nexus and Claudia.",
    liveStatus: "Online",
    inactiveStatus: "Offline",
  },
  viktor_retrieval: {
    title: "Viktor Retrieval",
    description: "Read-only SAGE Knowledge Base retrieval service.",
    liveStatus: "Ready",
  ...
  cleanup_storage: {
    ...
    description: "Automatic Claudia runtime cleanup and retention scheduling.",
